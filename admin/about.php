...
<?php
 ...
 if (isset($_POST['addabout'])){
    ...
    if (move_uploaded_file($_FILES['image']['tmp_name'],$target)){
        $sql=mysqli_query($conn,"INSERT INTO aboutus VALUES ('','$servicetitle','$image','$description')");
        if ($sql) {
            $successmessage .='Add About Successfully';  
        }
        else {
            $errormessage .='Add About failed!'.$conn->error;     
        }    
    }
    else{
        $errormessage .='Add About failed! Try Again';
    }
}
                                       ...
                                       <form action="" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <?php
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input  type="submit" name="addabout" value="Add about" class="btn btn-primary" style="width: 100%;">
                                                            </div>
                                                        </div>
                                                    </form>
                                    </div>
                                                   ...
                                                   <table id="zero_config" class="table  table-bordered no-wrap">
                                                    ...
                                                    <?php
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a class="btn btn-danger"  href="delete.php?delabout=<?php echo $row['id']; ?> " onclick="return confirm('are you sure! you want to delete this abount content.')" id="red">Delete</a></td>
