...
$seri_id=$_GET['updateabout'];
 ...
 if (isset($_POST['updatabout'])){
   ...
   $others=$_POST['others'];
    if($image==''){
       $sql=mysqli_query($conn,"UPDATE about SET title='$title', description='$description' WHERE id=$seri_id;");
    }else{
   $sql=mysqli_query($conn,"UPDATE about SET title='$title', description='$description', photo='$image' WHERE id=$seri_id;");
 }
   if ($sql) {
                                       ...
                                       <form action="" method="POST" enctype="multipart/form-data">
                                            ...
                                            <?php
                                                if (isset($_GET['updateabout'])) {
                                                    $recp_id=$_GET['updateabout'];
                                                    $quer=mysqli_query($conn,"SELECT * FROM about WHERE about.id=$recp_id");
                                                    ...
                                                    <form action="" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input  type="submit" name="updatabout" value="Update content" class="btn btn-primary" style="width: 100%;">
                                                            </div>
                                                        </div>
                                                    </form>
                                                        <?php
