...
<?php
 if (isset($_POST['addabout'])){
    ...
    if (move_uploaded_file($_FILES['image']['tmp_name'],$target)){
        $sql=mysqli_query($conn,"INSERT INTO classes VALUES ('','$servicetitle','$image','$description')");
        if ($sql) {
            $successmessage .='Add class Successfully';  
        }
        else {
            $errormessage .='Add class failed!'.$conn->error;     
        }    
    }
    else{
        $errormessage .='Add class failed! Try Again';
    }
}
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5">
                            <div class="section-block">
                                <h5 class="section-title">CLasses</h5>
                            </div>
                                       ...
                                       <form action="" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <?php
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input  type="submit" name="addabout" value="Add Class" class="btn btn-primary" style="width: 100%;">
                                                            </div>
                                                        </div>
                                                    </form>
                                    </div>
                                                   ...
                                                   <table id="zero_config" class="table  table-bordered no-wrap">
                                                    ...
                                                    <?php
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a class="btn btn-danger"  href="delete.php?delclass=<?php echo $row['id']; ?> " onclick="return confirm('are you sure! you want to delete this abount content.')" id="red">Delete</a></td>
                                                            <td><a class="btn btn-primary"  href="aboutupdate.php?updateabout=<?php echo $row['id']; ?>"  id="red">Update</a></td>
                                                        </tr>
                                                        <?php
                                                            }
                                                            ?>
