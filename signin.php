...
<main class="page-center">
  <article class="sign-up">
    <h1 class="sign-up__title">Welcome to Kider!</h1>
    ...
    <form class="sign-up-form form" action="" method="POST">
      ...
      <button class="form-btn primary-default-btn transparent-btn" style="background-color:orange;" type="submit" name="sign">Sign in</button>
    </form>
  </article>
</main>
<!-- Chart library -->
