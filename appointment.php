                            ...
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                ...
                                <form method="POST">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-floating">
                                                <input type="text" name="date_meet" class="form-control border-0" id="cname" placeholder="Child Name">
                                                <label for="date_meet">Date Preferred</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-floating">
                                                <input type="text" name="time_prefer" class="form-control border-0" id="cage" placeholder="Child Age">
